...
import { faAngleDoubleDown, faAngleDown, faChevronDown, faPowerOff, faUser } from '@fortawesome/free-solid-svg-icons';
        ...
        <ul className="nav-menu-desktop">
          ...
          <div className="nav-item-container has-submenu">
            ...
            <ul className="submenu-list">
              ...
              <li><NavLink to={LOCAL_URL + "/cajero/lista-empleadores"} className="submenu-link">Listar Empleadores</NavLink></li>
            </ul>
          </div>
          <div className="nav-item-container has-submenu">
            <NavLink to="#" className="nav-link-item" onClick={(e) => e.preventDefault()}>
            ...
            <ul className="submenu-list">
              ...
              <li><NavLink to={LOCAL_URL + "/cajero/lista-cajas"} className="submenu-link">Lista de Cajas</NavLink></li>
            </ul>
          </div>
          <div className="nav-item-container has-submenu">
            <NavLink to="#" className="nav-link-item" onClick={(e) => e.preventDefault()}>
        ...
        {window.innerWidth < 1200 ? <>
          ...
          <div className={`nav-menu-mobile ${isMobileMenuOpen ? 'open' : ''}`}>
            ...
            <div className="nav-item-container has-submenu">
              ...
              <ul className="submenu-list">
                <li><NavLink to={LOCAL_URL + "/cajero/nuevo-caja"} className="submenu-link">Aperturar Caja</NavLink></li>
                <li><NavLink to={LOCAL_URL + "/cajero/lista-cajas"} className="submenu-link">Lista Cajas</NavLink></li>
              </ul>
            </div>
