        ...
        <div className="alert alert-success border-0 shadow-sm mb-4" style={{ backgroundColor: '#f8fdf9', padding: '15px', marginTop:'10px', borderLeft: '5px solid #1bbec0' }}>
            <div className="row g-2 small">
                <div className="col-md-6 col-12">
                    ...
                    <div className="fw-bold text-dark">
                        TOTAL GASTADO: <span className="text-danger">CLP. {gastos.toFixed(2)}</span>
                    </div>
                </div>
                ...
                <div className="col-md-6 col-12 text-md-end">
                    {localStorage.getItem('numRol') < 4 && (
                        <div className="text-muted" style={{ fontSize: '0.75rem' }}>
                            ABONO TOTAL RECIBIDO: <span className="fw-bold">CLP. {ingresos.toFixed(2)}</span>
                        </div>
                    )}
                    <div className="fw-bold text-dark">
                        SALDO DISPONIBLE: <span className="text-success">CLP. {saldo.toFixed(2)}</span>
                    </div>
                </div>
            </div>
            ...
            <div className="mt-3">
                <div className="d-flex justify-content-between mb-1" style={{ fontSize: '0.75rem' }}>
                    ...
                    <span className="fw-bold text-success">A FAVOR ({porcentajeSaldo.toFixed(1)}%)</span>
                </div>
                ...
                <div className="d-flex justify-content-between mt-1" style={{ fontSize: '0.65rem', color: '#6c757d' }}>
                    <span>Total Abonado:    </span> <span>{'CLP. '+ingresos.toFixed(2)}</span>
                </div>
            </div>
        </div>
    );
