...
function ParametroMapsEstratificado() {
                    ...
                    <Row>
                        ...
                        <Col md={12} className='mb-5'>
                            <p className='titulo-parametros-mapa'>
                                PARAMETROS DE GENERACION MAPAS
                            </p>
                        </Col>
                        ...
                        <Col md={12} style={{
                            ...
                            {(!option.campo ) || !level ?
                                ...
                                <Link
                                    to={`/smd/generar-mapa-estratificado/${level === 4?option1.campo: option.campo}/${level}`}
...
export default ParametroMapsEstratificado;